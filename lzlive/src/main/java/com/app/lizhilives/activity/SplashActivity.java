...
public class SplashActivity extends Activity implements SplashADListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (Build.VERSION.SDK_INT >= 23) {
      ...
      fetchSplashAD(this, container, skipView, LConstant.APPID, getPosId(), this, 0);
    }
  }

  private String getPosId() {
    String posId = getIntent().getStringExtra("pos_id");
    return TextUtils.isEmpty(posId) ? LConstant.SplashPosID : posId;
  }
  ...
  public void onNoAD(AdError error) {
    ...
    handler.postDelayed(new Runnable() {
      @Override
      public void run() {
        SplashActivity.this.startActivity(new Intent(SplashActivity.this, MainActivityOne.class));
  ...
  private void next() {
    if (canJump) {
      this.startActivity(new Intent(this, MainActivityOne.class));
      this.finish();
    } else {
      canJump = true;
    }
