...
package com.app.lizhilives.host;
 ...
 * complete}
 */
public class FragmentTabHost2 extends TabHost
    ...
    public FragmentTabHost2(Context context) {
    ...
    public FragmentTabHost2(Context context, AttributeSet attrs) {
        super(context, attrs);
